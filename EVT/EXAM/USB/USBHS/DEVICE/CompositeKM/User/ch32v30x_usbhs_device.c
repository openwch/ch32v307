...
volatile BOOL   USBHS_Endp1_T_Tog = 0;                                          /* USB2.0高速设备端点1tog位翻转 */
...
volatile BOOL   USBHS_Endp2_T_Tog = 0;                                          /* USB2.0高速设备端点2tog位翻转 */
...
UINT8  MyCfgDescr_HS[ ] =
{
    ...
    0x09,0x04,0x00,0x00,0x01,0x03,0x01,0x01,0x00,                    //接口描述符,键盘
    0x09,0x21,0x11,0x01,0x00,0x01,0x22,KeyRepDescSize&0xFF,KeyRepDescSize>>8,//HID类描述符
    0x07,0x05,0x81,0x03,DEF_USB_HS_EP_SIZE&0xFF,DEF_USB_HS_EP_SIZE>>8,0x0a,                       //端点描述符

    0x09,0x04,0x01,0x00,0x01,0x03,0x01,0x02,0x00,                    //接口描述符,鼠标
    0x09,0x21,0x10,0x01,0x00,0x01,0x22,MOUSRepDescSize&0xFF,MOUSRepDescSize>>8,//HID类描述符
    0x07,0x05,0x82,0x03,DEF_USB_HS_EP_SIZE&0xFF,DEF_USB_HS_EP_SIZE>>8,0x0a                        //端点描述符
};
