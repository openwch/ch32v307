...
extern UINT8  MyDevDescr[ ];
extern UINT8 MyCfgDescr_FS[ ];
extern UINT8 MyCfgDescr_HS[ ];
...
extern const UINT8 MyUSBQUADesc[ ];
extern const UINT8 MyBOSDesc[ ];
extern UINT8 TAB_USB_FS_OSC_DESC[ ];
extern UINT8 TAB_USB_HS_OSC_DESC[ ];
...
extern void Ep1_Tx( PUINT8 data, UINT8 len );                                   /* USB2.0高速设备端点1 上传处理 */
extern void Ep2_Tx( PUINT8 data, UINT8 len );                                   /* USB2.0高速设备端点1 上传处理 */
