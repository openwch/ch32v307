...
/*******************************************************************************
* Function Name  : PWR_EnterSTANDBYMode_RAM_VBAT_EN
* Description    : Enters STANDBY mode with RAM data retention function on (VBAT Enable).
* Input          : None
* Return         : None
*******************************************************************************/
...
/*******************************************************************************
* Function Name  : PWR_EnterSTANDBYMode_RAM_LV_VBAT_EN
* Description    : Enters STANDBY mode with RAM data retention function and LV mode on(VBAT Enable).
* Input          : None
* Return         : None
*******************************************************************************/
