...
/* globe variable */
extern ETH_DMADESCTypeDef  *DMATxDescToSet;   //设置发送描述符后发送
extern ETH_DMADESCTypeDef  *DMARxDescToGet;   //获取当前接受描述符
...
INIT_DEVICE_EXPORT(rt_hw_ch32_eth_init);/* 加入到device初始化中 */
